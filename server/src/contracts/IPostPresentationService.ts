...
export interface IPostPresentationService {
    getPostsByUser(author: string, settings: PostViewSettings) : Crumb[]
    getPostsByTags(tags: string[], settings: PostViewSettings): Crumb[]
    getReplies(postID: string, settings: PostViewSettings): Crumb[]
    getGuestFeed(settings: PostViewSettings) : Crumb[]
    getPersonalFeed(username: string, settings: PostViewSettings): Crumb[]
}
